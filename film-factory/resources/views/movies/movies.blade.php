   ...
   <nav x-data="{ open: false }" class="bg-pink border-b border-gray-100 sticky top-0 z-50">
      ...
      <div class="flex">
         <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="bottom-nav">
               {{ __('Home') }}
            </x-nav-link>
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="bottom-nav">
               {{ __('Cinemas') }}
      ...
      <div class="container mx-auto px-4 pt-16">
        ...
        <div class="now-playing-movies py-24">
            ...
            <div class="mt-8">
                  ...
                  <a href="">
                     <img src="{{URL::asset('/images/joker.jpg')}}" alt="super mario">
                  </a>
                  <div class="bg-white py-4 px-2">
                     <a href="" class="text-lg mt-2 text-gray-500 b">The Super Marion Bros</a>
                     <span class="mx-2 text-gray-400">|</span>
                  ...
                  <a href="">
                     <img src="{{URL::asset('/images/flash.jpg')}}" alt="super mario">
                  </a>
                  <div class="bg-white py-4 px-2">
                     <a href="" class="text-lg mt-2 text-gray-500 b">The Super Marion Bros</a>
                     <span class="mx-2 text-gray-400">|</span>
